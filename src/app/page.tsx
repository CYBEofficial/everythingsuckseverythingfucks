...
export default function Home() {
  ...
  const basePath = process.env.NODE_ENV === 'production' ? '/everythingsuckseverythingfucks' : '';
  const gifs = [
    `${basePath}/assets/creeping-video-game.gif`,
    `${basePath}/assets/bioware-mass-effect.gif`,
    `${basePath}/assets/да-конечно.gif`,
    `${basePath}/assets/6P4G4_O1GI095KVU3C9.gif`,
    `${basePath}/assets/vsgif_com__.2872463.gif`,
    `${basePath}/assets/pigeon-ai-pigeon-brainrot.gif`,
    `${basePath}/assets/dusku.gif`,
    `${basePath}/assets/tenor.gif`,
    `${basePath}/assets/yaya-alien.gif`,
    `${basePath}/assets/xd-horses.gif`,
    `${basePath}/assets/bCAlveo.gif`,
    `${basePath}/assets/weird-trippy.gif`,
    `${basePath}/assets/fish-wtf.gif`,
    `${basePath}/assets/sticker_2.gif`,
    `${basePath}/assets/image0 (1).gif`,
    `${basePath}/assets/vsgif_com__.2877797.gif`,
    `${basePath}/assets/fish.gif`,
    `${basePath}/assets/TVo9.gif`,
    `${basePath}/assets/4f8W.gif`,
    `${basePath}/assets/6kVieam.gif`,
    `${basePath}/assets/Gw0uu9eWsAA3jbX.gif`,
    `${basePath}/assets/boa-tarde.gif`,
    `${basePath}/assets/bp7.gif`,
    `${basePath}/assets/brainrot-nerve-burst.gif`,
    `${basePath}/assets/ekoi-ekoi-dancekid.gif`,
    `${basePath}/assets/fetrt.gif`,
    `${basePath}/assets/formg.gif`,
    `${basePath}/assets/george-carlin-content-aware-scaling.gif`,
    `${basePath}/assets/gif.gif`,
    `${basePath}/assets/giphy.gif`,
    `${basePath}/assets/glitch-crazy.gif`,
    `${basePath}/assets/heavy-rain-game-glitch.gif`,
    `${basePath}/assets/horse.gif`,
    `${basePath}/assets/locked-in-alien-alien.gif`,
    `${basePath}/assets/pigeon-lebron.gif`,
    `${basePath}/assets/pigeon-tired.gif`,
    `${basePath}/assets/puffer-fish.gif`,
    `${basePath}/assets/rat-dance.gif`,
    `${basePath}/assets/rock-wwe.gif`,
    `${basePath}/assets/shiteyanyo-speen.gif`,
    `${basePath}/assets/spongebob-spongebob-meme.gif`,
    `${basePath}/assets/thumbs-up.gif`,
    `${basePath}/assets/tumblr_p3kgnuboc41wvuif9o1_500.gif`,
    `${basePath}/assets/vacuate.gif`,
    `${basePath}/assets/vsgif_com_d-sanic-running-slowly_.3493758.gif`,
    `${basePath}/assets/vsgif_com_sanic-slaps-a-person_.3494570.gif`,
    `${basePath}/assets/xd-meme.gif`,
  ];
